...
const navigation = [
  ...
  { label: "Finance", items: [
    ...
    { label: "Proforma invoices", href: "/proforma-invoices", icon: FileSignature, permission: "finance.view" },
    ...
    { label: "Purchase orders", href: "/purchase-orders", icon: ShoppingBag, permission: "finance.view" },
    { label: "Work orders", href: "/work-orders", icon: BriefcaseBusiness, permission: "finance.view" },
